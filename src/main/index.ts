      ...
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          isDev
            ...
            : "default-src 'self'; script-src 'self' 'wasm-unsafe-eval' https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self' data:; connect-src 'self' https://tessdata.projectnaptha.com https://cdn.jsdelivr.net; worker-src 'self' blob: https://cdn.jsdelivr.net;",
        ],
      },
    });
  });
